...
<!--
**MissMeriel/MissMeriel** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- **Languages**: &nbsp;                          Python, C++, Matlab, SQL (Postgres), TypeScript
- **Frameworks**: &nbsp;&nbsp;                   PyTorch, Flask/FastAPI, Rails, React, Node.js
- **Developer Tools**:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Git, Docker, VS Code, PyCharm
- **Libraries**:  &nbsp;&nbsp;&nbsp;&nbsp;          pandas, NumPy, Huggingface, Matplotlib, plotly, Ardupilot, ROS1&2
